...
ALTER TYPE care_plan_status ADD VALUE IF NOT EXISTS 'pending_client_approval';
ALTER TYPE care_plan_status ADD VALUE IF NOT EXISTS 'client_approved';
ALTER TYPE care_plan_status ADD VALUE IF NOT EXISTS 'client_rejected';
...
CREATE TRIGGER handle_updated_at_care_plan_status_history
