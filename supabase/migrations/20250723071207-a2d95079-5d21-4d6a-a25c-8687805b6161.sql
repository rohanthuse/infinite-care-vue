...
-- Fix the safe_setup_client_auth function to resolve ambiguous column reference
...
-- Now link the specific client to their auth user
SELECT public.safe_setup_client_auth(
  'd844f7b5-087c-4594-ace8-9bfb0a03e66e'::uuid,
  'temporary123',
  '42087c0d-30b7-4f54-bae6-a0b87ebf5983'::uuid
);
