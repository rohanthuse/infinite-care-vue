-- Drop and recreate the get_optimized_tenant_data RPC function to properly fetch subscription plan details
-- This fixes the column name from user_id to system_user_id and improves the JOIN logic
