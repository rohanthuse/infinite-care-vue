-- Fix the admin_set_client_password function to properly link client records to auth users
...
BEGIN
  ...
  -- CRITICAL FIX: Update client record with auth_user_id link and temporary password info
...
-- Fix the current orphaned client record for sg@gmail.com
UPDATE public.clients 
SET auth_user_id = '181f4b72-285b-42e5-833f-3163fcd62e0b'
WHERE email = 'sg@gmail.com' AND auth_user_id IS NULL;

-- Ensure the client role is properly assigned
INSERT INTO public.user_roles (user_id, role) 
VALUES ('181f4b72-285b-42e5-833f-3163fcd62e0b', 'client')
ON CONFLICT (user_id, role) DO NOTHING;