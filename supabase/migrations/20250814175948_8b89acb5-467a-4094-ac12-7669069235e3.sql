-- Create missing branch for Shashank Care Services with required fields
INSERT INTO public.branches (id, name, organization_id, address, phone, email, status, country, postcode, region, created_at, updated_at)
VALUES (
  gen_random_uuid(),
  'Main Branch',
