-- Create missing branch for Shashank Care Services with all required fields
INSERT INTO public.branches (id, name, organization_id, address, phone, email, status, country, currency, created_at, updated_at)
VALUES (
  gen_random_uuid(),
  'Main Branch',
