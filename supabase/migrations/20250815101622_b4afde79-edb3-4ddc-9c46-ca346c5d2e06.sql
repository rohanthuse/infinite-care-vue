-- Fix system users organization display by properly dropping and recreating the function

-- Drop existing function first
DROP FUNCTION IF EXISTS list_system_users_with_session(TEXT);
...
-- Recreate the original function with the enhanced logic
...
AS $$
BEGIN
  -- Use the enhanced function and return all fields including organizations
  RETURN QUERY
  SELECT * FROM list_system_users_with_session_and_orgs(p_session_token);
END;
$$;