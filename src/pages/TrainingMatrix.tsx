      ...
      <main className="flex-1 container mx-auto px-4 py-6">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="p-8 bg-white rounded-lg border border-gray-200 shadow-sm text-center">
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-2">Training Matrix</h3>
            <p className="text-gray-500 max-w-md mx-auto">
              Training Matrix content will be implemented soon. This page will display staff training compliance and certifications.
            </p>
          </div>
        </div>
      </main>
