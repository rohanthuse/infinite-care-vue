...
const TenantCarerLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Verify user is a staff member and belongs to this organization
      ...
      // Success - redirect to carer dashboard
      toast({
        title: 'Welcome!',
        description: `Welcome back, ${staffData.first_name}!`,
      });

      navigate(`/${tenantSlug}/carer-dashboard`);
    } catch (error: any) {
        ...
        <Card className="border-0 shadow-xl bg-white/95 backdrop-blur-sm">
          <CardHeader className="space-y-4 text-center">
            ...
            <div>
              ...
              <CardDescription className="text-gray-600 mt-2">
                Carer Portal - Sign in to access your care dashboard
              </CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isSubmitting ? 'Signing In...' : 'Sign In to Carer Portal'}
              </CustomButton>
            </form>
...
export default TenantCarerLogin;