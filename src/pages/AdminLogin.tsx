...
import { Heart, Lock, AlertCircle, Eye, EyeOff, Mail, Shield } from "lucide-react";
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description: "Welcome back to Med-Infinite Admin Portal!",
        });
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-600 to-blue-500 text-white p-8 flex-col justify-center relative overflow-hidden">
        <div className="z-10 max-w-lg">
          ...
          <p className="text-xl font-light mb-4">
            Your Gateway to Comprehensive Management
          </p>
          
          <p className="text-blue-100 mb-8 max-w-md">
            Access the Med-Infinite administration dashboard to manage branches, staff, clients, and oversee all operations with powerful tools and insights.
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-blue-100">
              This portal is for Super Administrators and Branch Administrators only. 
      ...
      <div className="w-full md:w-1/2 bg-white flex items-center justify-center p-6">
        <div className="max-w-md w-full">
          <div className="text-center md:text-left mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Med-Infinite Admin</h2>
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Sign in</h3>
            <p className="text-gray-600">to access the administration portal</p>
          </div>
