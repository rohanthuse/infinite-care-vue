              ...
              <CardContent className="pt-5 pb-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-orange-900 mb-1.5 text-lg">
        ...
        >
          ...
          <CardContent className="pt-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-3 p-3 rounded-lg border border-blue-200 bg-blue-50/50 hover:bg-blue-50 transition-colors">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-700 font-medium">Goals</p>
                </div>
              </div>
              
              <div className="flex items-center gap-3 p-3 rounded-lg border border-green-200 bg-green-50/50 hover:bg-green-50 transition-colors">
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg border border-purple-200 bg-purple-50/50 hover:bg-purple-50 transition-colors">
                <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center shrink-0">
                  <FileText className="h-5 w-5 text-purple-600" />
                </div>
                <div>
                  <p className="text-2xl font-bold text-purple-900">{carePlan.activities?.length || 0}</p>
                  <p className="text-xs text-purple-700 font-medium">Activities</p>
                </div>
              </div>
              
              <div className="flex items-center gap-3 p-3 rounded-lg border border-orange-200 bg-orange-50/50 hover:bg-orange-50 transition-colors">
                <div className="w-10 h-10 rounded-full bg-orange-100 flex items-center justify-center shrink-0">
                  <AlertCircle className="h-5 w-5 text-orange-600" />
                </div>
                <div>
                  <p className="text-2xl font-bold text-orange-900">{carePlan.risk_assessments?.length || 0}</p>
                  <p className="text-xs text-orange-700 font-medium">Risks</p>
                </div>
              </div>
            </div>
            ...
            {carePlan.review_date && (
              <div className="flex items-center gap-2 p-2.5 rounded-lg bg-gray-100 border border-gray-200">
                <Clock className="h-4 w-4 text-gray-600" />
                <div className="flex-1">
                  <span className="text-xs font-medium text-gray-700">Next Review: </span>
