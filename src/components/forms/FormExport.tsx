...
import { FormMatrix } from "@/types/form";
import { toast } from "@/hooks/use-toast";

interface FormExportProps {
  matrixData: FormMatrix;
}

const FormExport: React.FC<FormExportProps> = ({ matrixData }) => {
  ...
  const handleExportCSV = () => {
    try {
      ...
      matrixData.forms.forEach(form => {
        headers.push(form.title);
      });
      ...
      link.setAttribute("download", "form_matrix.csv");
      ...
      toast({
        ...
        description: "Form matrix exported to CSV",
      });
    } catch (error) {
