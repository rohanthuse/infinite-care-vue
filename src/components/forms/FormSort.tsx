...
export type SortOption = {
  field: "name" | "completion" | "category" | "dueDate" | "status" | "lastUpdated";
  direction: "asc" | "desc";
}

interface FormSortProps {
  onSort: (option: SortOption) => void;
  currentSort: SortOption;
}

const FormSort: React.FC<FormSortProps> = ({ onSort, currentSort }) => {
      ...
      <PopoverContent className="w-[240px] p-4">
        <div className="space-y-4">
          ...
          >
            ...
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="lastUpdated" id="sort-last-updated" />
              <Label htmlFor="sort-last-updated">Last Updated</Label>
            </div>
          </RadioGroup>
