...
const WorkflowContent = ({
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
      <div className="mb-8">
        <h4 className="text-lg font-semibold text-gray-800 tracking-tight mb-4">Core Workflow Elements</h4>
      ...
      <div className="mb-8">
        <h4 className="text-lg font-semibold text-gray-800 tracking-tight mb-4">Additional Workflows</h4>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
