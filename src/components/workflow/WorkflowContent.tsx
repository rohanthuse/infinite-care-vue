...
const WorkflowContent = ({ branchId, branchName }: WorkflowContentProps) => {
  ...
  return (
    <>
      ...
      >
        {/* Add Notifications Overview component with branch context */}
        <NotificationsOverview branchId={branchId} branchName={branchName} />
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <Card 
              className="bg-white hover:bg-gray-50 transition-colors cursor-pointer border border-gray-200"
              onClick={() => handleNavigate('task-matrix')}
            >
              <CardContent className="p-4 flex flex-col items-center justify-center text-center">
