    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          {branchName && (
            <p className="text-sm text-muted-foreground">Managing invoices for {branchName}</p>
          )}
        </div>
                  ...
                  <TableCell>
                    <div>
                      ...
                      {invoice.client_pin_code && (
                        <div className="text-sm text-muted-foreground">{invoice.client_pin_code}</div>
                      )}
                    </div>
                  </TableCell>
                    ...
                    <div className="flex justify-center gap-1 flex-wrap">
                      ...
                      {canLock ? (
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => onLockInvoice?.(invoice.id)}
                          title="Lock Invoice"
                        >
