...
import { useClientSendMessage } from '@/hooks/useClientMessaging';
import { Paperclip, Send, X, Loader2 } from 'lucide-react';

interface ClientMessageInputBarProps {
  threadId: string;
}

export const ClientMessageInputBar: React.FC<ClientMessageInputBarProps> = ({
  threadId
}) => {
