...
const formSchema = z.object({
  ...
  risk_assessments: z.object({
    falls: z.string().optional(),
    wandering: z.string().optional(),
    choking: z.string().optional(),
    skin_breakdown: z.string().optional(),
    medication_errors: z.string().optional(),
    suicide: z.string().optional(),
    elopement: z.string().optional(),
  }).optional(),
  equipment: z.object({
