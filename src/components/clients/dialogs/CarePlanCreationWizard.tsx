...
const carePlanSchema = z.object({
  ...
  client_risk_info: z.object({
    rag_status: z.string().optional().default(""),
    has_pets: z.boolean().optional().default(false),
    fall_risk: z.string().optional().default(""),
    risk_to_staff: z.array(z.string()).optional().default([]),
    adverse_weather_plan: z.string().optional().default(""),
  }).optional(),
  client_personal_risk: z.object({
    lives_alone: z.boolean().optional().default(false),
    rural_area: z.boolean().optional().default(false),
    cared_in_bed: z.boolean().optional().default(false),
    smoker: z.boolean().optional().default(false),
    can_call_for_assistance: z.boolean().optional().default(false),
    communication_needs: z.string().optional().default(""),
    social_support: z.string().optional().default(""),
    fallen_past_six_months: z.boolean().optional().default(false),
    has_assistance_device: z.boolean().optional().default(false),
    arrange_assistance_device: z.boolean().optional().default(false),
  }).optional(),
