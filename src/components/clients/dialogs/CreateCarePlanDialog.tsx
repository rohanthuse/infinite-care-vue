...
export function CreateCarePlanDialog({ 
  ...
  const createCarePlanMutation = useMutation({
    mutationFn: async (carePlanData: FormValues) => {
      ...
      // Prepare the data based on provider type - note: display_id will be auto-generated by the trigger
      const insertData: any = {
        ...
        status: 'active'
        // display_id is omitted - it will be auto-generated by the database trigger
      };
