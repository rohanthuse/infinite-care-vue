...
export function FluidBalanceDisplay({ clientId, serviceDate, visitRecordId, showHeader = true }: FluidBalanceDisplayProps) {
  ...
  // When showHeader is false, render content without Card wrapper
  if (!showHeader) {
    return (
