    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] rounded-xl">
        <DialogHeader className="pb-4">
          ...
          <DialogDescription>
            <span className="font-medium text-foreground">{adminName}</span> has access to multiple branches. 
        ...
        <div className="space-y-3">
          {branches.map((branch) => (
            <Button
              ...
              variant="outline"
              className="w-full h-auto p-4 justify-between hover:bg-accent hover:border-primary/30 transition-colors"
            ...
            >
              <div className="flex items-center">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-muted-foreground">Branch ID: {branch.branch_id.slice(0, 8)}...</div>
                </div>
              </div>
