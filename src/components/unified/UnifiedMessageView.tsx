...
import { useThreadMessages, useUnifiedUser } from "@/hooks/useUnifiedMessaging";

interface UnifiedMessageViewProps {
  threadId: string;
  onReply: () => void;
}

export const UnifiedMessageView = ({ threadId, onReply }: UnifiedMessageViewProps) => {
  ...
  const getTypeBadge = (senderType: string, senderId: string) => {
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <div className="flex items-center">
                  ...
                  {getTypeBadge(message.senderType, message.senderId)}
                </div>
