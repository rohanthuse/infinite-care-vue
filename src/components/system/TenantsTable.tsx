...
import { Building, Eye, Edit, Trash2, Plus } from 'lucide-react';
...
export const TenantsTable = ({ tenants, isLoading, onAddTenant }: TenantsTableProps) => {
  if (isLoading) {
    return (
      <Card>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Manage and monitor tenant organizations
            </p>
          </div>
