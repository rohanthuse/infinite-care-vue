...
const ClientHeader: React.FC<{ title: string }> = ({ title }) => {
  ...
  return (
    <header 
      className="bg-gradient-to-r from-white via-white to-indigo-50/40 dark:from-card dark:via-card dark:to-indigo-950/20 shadow-sm shadow-indigo-100/20 dark:shadow-indigo-900/10 border-b border-gray-100 dark:border-border py-3 lg:py-4 sticky top-0 z-[60] w-full relative after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-gradient-to-r after:from-blue-500 after:via-indigo-500 after:to-purple-500"
